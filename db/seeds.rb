...
p1 = Product.new({title:"Margeritha", price:"6.00", pic_url:"pizzas/pizza01.jpg"})
p2 = Product.new({title:"Funghi", price:"7.00", pic_url:"pizzas/pizza02.jpg"})
p3 = Product.new({title:"Roma", price:"6.50", pic_url:"pizzas/pizza03.jpg"})
p4 = Product.new({title:"Napoli", price:"7.00", pic_url:"pizzas/pizza04.jpg"})
p5 = Product.new({title:"Milano", price:"7.50", pic_url:"pizzas/pizza05.jpg"})
p6 = Product.new({title:"Venezia", price:"8.00", pic_url:"pizzas/pizza06.jpg"})
p7 = Product.new({title:"Bergamo", price:"8.00", pic_url:"pizzas/pizza07.jpg"})
p8 = Product.new({title:"Quattro Formaggi", price:"9.50", pic_url:"pizzas/pizza08.jpg"})
p9 = Product.new({title:"Firenze", price:"8.00", pic_url:"pizzas/pizza09.jpg"})
p10 = Product.new({title:"Pisa", price:"8.50", pic_url:"pizzas/pizza10.jpg"})
p11 = Product.new({title:"Torino", price:"8.00", pic_url:"pizzas/pizza11.jpg"})
p12 = Product.new({title:"Palermo", price:"7.00", pic_url:"pizzas/pizza12.jpg"})
p13 = Product.new({title:"Hawaii", price:"7.50", pic_url:"pizzas/pizza13.jpg"})
p14 = Product.new({title:"Kreta", price:"8.00", pic_url:"pizzas/pizza14.jpg"})
p15 = Product.new({title:"After Burner", price:"8.00", pic_url:"pizzas/pizza15.jpg"})
